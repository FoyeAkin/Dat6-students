...
Xlist= ['Season', 'holiday', 'Workday', 'weather', 'temp', 'atemp',
...
reg_dict={'RMSE':reg_scores ,'variable':Xlist}
cas_dict ={'RMSE':cas_scores ,'variable':Xlist} 
...
cas_scores.sort_index(by='RMSE')
reg_scores.sort_index(by='RMSE')
...
CASUAL MODEL
'''
casmodelX=['temp','Workday','Hour','humidity',
           'holiday', 'Year',
           'weather_2','weather_3','weather_4',
           'Weekday_1','Weekday_2', 'Weekday_3','Weekday_4','Weekday_5','Weekday_6']
...
cas_score=cross_val_score(mlm, train[casmodelX], train['casual'], cv=10,
                          scoring='mean_squared_error')
...
REGISTERED MODEL
'''
regmodelX=['Hour','temp','Year','humidity',
           'Workday','windspeed','Year',
           'weather_2','weather_3','weather_4',
           'Weekday_1','Weekday_2', 'Weekday_3','Weekday_4','Weekday_5','Weekday_6']
